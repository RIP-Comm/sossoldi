  ...
  group("Bank Account Methods", () {
    ...
    test("selectAll", () async {
      ...
      demoTransactions.add(createInsertSqlTransaction(
          date: fistOfCurrentMonth.subtract(const Duration(days: 10)), idBankAccount: 71));
      demoTransactions.add(createInsertSqlTransaction(
      ...
      demoTransactions.add(createInsertSqlTransaction(
          date: fistOfCurrentMonth.add(const Duration(days: 1)), idBankAccount: 71));
      demoTransactions.add(createInsertSqlTransaction(
      ...
      demoTransactions.add(createInsertSqlTransaction(
          date: fistOfCurrentMonth.add(const Duration(days: 2)), type: 'IN'));
      demoTransactions.add(createInsertSqlTransaction(
          date: fistOfCurrentMonth.add(const Duration(days: 2)), idBankAccount: 71));
    ...
    test("accountDailyBalance", () async {
      ...
      demoTransactions.add(createInsertSqlTransaction(
          date: fistOfCurrentMonth.add(const Duration(days: 32)), idBankAccount: 71));
      ...
      var result = await BankAccountMethods().accountDailyBalance(70,
          dateRangeStart:
              DateTime(DateTime.now().year, DateTime.now().month, 1), // beginnig of current month
          dateRangeEnd:
              DateTime(DateTime.now().year, DateTime.now().month + 1, 1)); // beginnig of next month
      expect(result.length, 3);
      ...
      result = await BankAccountMethods().accountDailyBalance(71,
          dateRangeStart:
              DateTime(DateTime.now().year, DateTime.now().month, 1), // beginnig of current month
          dateRangeEnd: DateTime(
              DateTime.now().year, DateTime.now().month + 1, 1)); // beginnig of next month;
      expect(result.length, 3);
