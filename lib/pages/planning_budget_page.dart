...
class _PlanningPageState extends ConsumerState<PlanningPage> with Functions {

  @override
  Widget build(BuildContext context) {

    final budgetList = ref.watch(budgetsProvider);
                                ...
                                return Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(budgets[index].name ?? '(Category?)',
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 16.0,
                                                fontFamily: 'SF Pro Text')),
