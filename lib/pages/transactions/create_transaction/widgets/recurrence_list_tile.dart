        ...
        ListTile(
          ...
          trailing: recurrencyEditingPermitted
              ...
              : GestureDetector(
                  onTap: () {
                    if (!isSnackBarVisible) {
                      ...
                      ScaffoldMessenger.of(context)
                          .showSnackBar(
                            SnackBar(
                              content: Text(AppLocalizations.of(context)!.switchDisabled),
                  ...
                  child: Tooltip(
                    message: AppLocalizations.of(context)!.switchDisabled,
              ...
              child: FilledButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      endDate?.formatEDMY() ?? AppLocalizations.of(context)!.never,
                      style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                        color: isDarkMode
                            ? grey3
                            : Theme.of(context).colorScheme.secondary,
              ...
              child: TextButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        AppLocalizations.of(context)!.recurringTransactionWarning,
                        style: const TextStyle(color: darkBlue5, fontSize: 13),
