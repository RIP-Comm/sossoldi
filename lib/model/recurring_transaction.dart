...
final Map<TransactionType, String> reverseTypeMap =
    typeMap.map((key, value) => MapEntry(value, key));
...
class RecurringTransaction extends BaseEntity {
  ...
  static RecurringTransaction fromJson(Map<String, Object?> json) =>
      RecurringTransaction(
          ...
          type: json[RecurringTransactionFields.type] != null
  ...
  Map<String, Object?> toJson() => {
        ...
        RecurringTransactionFields.type: reverseTypeMap[type],
...
class RecurringTransactionMethods extends SossoldiDatabase {
  ...
  void populateRecurringTransaction(String scope, DateTime lastTransactionDate,
    ...
    for (var tr in transactions2Add) {
      ...
      print('inserting transaction: ${transaction.type}');
