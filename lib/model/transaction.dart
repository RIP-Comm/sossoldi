...
class Transaction extends BaseEntity {
  ...
  static Transaction fromJson(Map<String, Object?> json) {
    final rawType = json[TransactionFields.type] as String;
    final typeValue = typeMap[rawType]!;
  ...
  Map<String, Object?> toJson({bool update = false}) {
    ...
    final typeKey = typeMap.keys.firstWhere((k) => typeMap[k] == type);

    return {
      TransactionFields.id: id,
      TransactionFields.date: date.toIso8601String(),
      TransactionFields.amount: amount,
      TransactionFields.type: typeKey,
